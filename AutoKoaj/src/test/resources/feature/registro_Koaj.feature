...
Característica: Registro de usuario en el portal de Koaj
  ...
  Escenario: Registro exitoso de un nuevo usuario
    ...
    Cuando el usuario completa el formulario con los datos: título "Sr.", nombre "Camilo", apellido "Guerra", correo "camilo.guerra@example.com", contraseña "Password123", tipo documento "Cédula de ciudadanía", número identificación "1234567890", día "12", mes "Mayo " y año "1995"
